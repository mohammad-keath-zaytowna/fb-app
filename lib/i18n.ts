...
export const RESOURCES = {
  en: {
    translation: {
      ...
      cannotRemoveLastItem: "Cannot remove the last item from an order",
      removeItem: "Remove Item",
      removeItemQuestion: "Are you sure you want to remove this item?",
      remove: "Remove",
      orderMustHaveOneItem: "Order must have at least one item",
      ...
      areYouSureChangeStatus: "Are you sure you want to change the status to",
      confirm: "Confirm",
      ...
      phoneNumberMinLength: "Phone number must be at least 8 characters",
      deliveryAddressRequired: "Delivery address is required",
      shippingCostMinimum: "Shipping cost must be 0 or greater",
      shippingCostNegative: "Shipping cost cannot be negative",
      discountMinimum: "Discount must be 0 or greater",
  ...
  ar: {
    translation: {
      ...
      addItemToOrder: "إضافة عنصر إلى الطلب",
      ...
      cannotRemoveLastItem: "لا يمكن إزالة العنصر الأخير من الطلب",
      removeItem: "إزالة العنصر",
      removeItemQuestion: "هل أنت متأكد من إزالة هذا العنصر؟",
      remove: "إزالة",
      orderMustHaveOneItem: "يجب أن يحتوي الطلب على عنصر واحد على الأقل",
      ...
      areYouSureChangeStatus: "هل أنت متأكد من تغيير الحالة إلى",
      confirm: "تأكيد",
      ...
      phoneNumberMinLength: "يجب أن يتكون رقم الهاتف من 8 أحرف على الأقل",
      deliveryAddressRequired: "عنوان التوصيل مطلوب",
      shippingCostMinimum: "يجب أن تكون تكلفة الشحن 0 أو أكثر",
      shippingCostNegative: "لا يمكن أن تكون تكلفة الشحن سالبة",
      discountMinimum: "يجب أن يكون الخصم 0 أو أكثر",
