...
import { Search, Filter, X, Plus, LogOut, ShoppingBag } from "lucide-react-native";
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.header}>
        ...
        >
          <LogOut size={24} color="#111827" />
        </Pressable>
        <Text style={styles.headerTitle}>Products</Text>
        <View style={styles.headerRight}>
          <Pressable onPress={() => router.push("/orders")} style={styles.headerIcon}>
            <ShoppingBag size={24} color="#111827" />
          </Pressable>
          <Pressable onPress={() => router.push("/products/new")} style={styles.headerIcon}>
